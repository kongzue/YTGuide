...
//        setLocalUserUUID(sharedPreferences.getString("UserUUID", ""));
    ...
    public static List<Map> getLocal_path() {
        if (local_path==null){
            ...
            local_path.add(addNewPath("第六教学楼","这里是第六教学楼",30.0022498775,106.2468822949));
            ...
            local_path.add(addNewPath("行政楼","这里是行政楼，学院领导以及各位老师办公地点就在这里。",30.0022500000,106.2449180000));
            local_path.add(addNewPath("移通正门","这里是移通正门，正门外有许多超市、餐厅，以及购物休闲场所，晚上会有重庆本地特色小吃摊。",30.0043950000,106.2469690000));
